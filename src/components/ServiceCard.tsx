...
export default function ServiceCard({ title, description, icon }: ServiceCardProps) {
    return (
        <Card className="group relative overflow-hidden bg-card border-border/50 hover:border-primary/50 shadow-sm hover:shadow-lg transition-all duration-500 flex flex-col h-full">
            <CardHeader>
            ...
            <CardContent className="flex flex-col flex-1">
                <div className="text-muted-foreground mb-6 flex-1">{description}</div>
